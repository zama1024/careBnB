...
l1 = Listing.create!({  title: "Beautiful house in a great city!",
  ...
  city: "San Francisco",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/1.jpg",
  max_guests: 3,
  num_bedroom: 2,
...
l4 = Listing.create!({  title: "Not like any other house",
  ...
  city: "San Francisco",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/2.jpg",
  max_guests: 3,
  num_bedroom: 2,
  listing_type: "Private Room",
  listing_beds: 2,
...
l2 = Listing.create!({  title: "Great apartment in SF",
  ...
  address: "Lombard Street",
  city: "San Francisco",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/3.jpg",
  max_guests: 3,
  num_bedroom: 2,
  listing_type: "Private Room",
  listing_beds: 2,
...
l3 = Listing.create!({  title: "Cozy New York Apartment",
  ...
  address: "Flushing",
  city: "New York",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/4.png",
  max_guests: 3,
  num_bedroom: 2,
  listing_type: "Private Room",
  listing_beds: 2,
...
l5 = Listing.create!({  title: "Small Rome apartment",
  ...
  address: "Italy",
  city: "Rome",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/5.jpg",
  max_guests: 3,
  num_bedroom: 2,
  listing_type: "Private Room",
  listing_beds: 2,
...
l6 = Listing.create!({  title: "Room for three in Rome",
  ...
  address: "Italy",
  city: "Rome",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/6.jpg",
  max_guests: 3,
  num_bedroom: 2,
  listing_type: "Private Room",
  listing_beds: 2,
...
l7 = Listing.create!({  title: "Great apartment for tourists in paris",
  ...
  address: "Paris",
  city: "France",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/7.jpg",
  max_guests: 3,
  num_bedroom: 2,
  listing_type: "Private Room",
  listing_beds: 2,
...
l8 = Listing.create!({  title: "Very welcoming house in paris",
  ...
  address: "Paris",
  city: "France",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/8.png",
  max_guests: 3,
  num_bedroom: 2,
  listing_type: "Private Room",
  listing_beds: 2,
...
l9 = Listing.create!({  title: "Cozy apartment in Amsterdam",
  ...
  address: "Netherland",
  city: "Amsterdam",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/9.jpg",
  max_guests: 3,
  num_bedroom: 2,
  listing_type: "Private Room",
  listing_beds: 2,
...
l10 = Listing.create!({  title: "One bedroom apartment in mumbai",
  ...
  address: "India",
  city: "Mumbai",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/10.jpg",
  max_guests: 3,
  num_bedroom: 2,
  listing_type: "Private Room",
  listing_beds: 2,
...
l11 = Listing.create!({  title: "Small apartment for tourists in London",
  ...
  address: "England",
  city: "London",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/11.jpg",
  max_guests: 3,
  num_bedroom: 2,
  listing_type: "Private Room",
  listing_beds: 2,
...
l12 = Listing.create!({  title: "Great house for tourists in barcelona",
  ...
  address: "Spain",
  city: "Barcelona",
  listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/12.jpg",
  max_guests: 3,
  num_bedroom: 2,
  listing_type: "Private Room",
  listing_beds: 2,
  ...
  l13 = Listing.create!({  title: "Beautiful house in San Francisco!",
    ...
    address: "18343 Lombard St.",
    city: "San Francisco",
    listing_photo_url: "https://s3.amazonaws.com/carebnb-photos/listingPhotos/13.jpg",
    max_guests: 3,
    num_bedroom: 2,
    listing_type: "Private Room",
    listing_beds: 2,
